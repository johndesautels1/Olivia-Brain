 ...
 *
 * LTM-port note: Companies House uses a separately-ported client at
 * `src/lib/companies-house/client.ts` (byte-for-byte from LTM). Other
 * integrations are OB-original because LTM doesn't host them.
 */
