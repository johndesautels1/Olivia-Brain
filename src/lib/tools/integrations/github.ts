...
export async function fetchGitHubRepoStats(
  ...
  return withMockFallback(
    ...
    async (signal) => {
      ...
      // Contributors are a separate endpoint; fail gracefully if rate-limited.
      ...
      return {
        ...
        contributorsCount,
        commitsLast30Days: 0, // Computed via /commits with since= filter; deferred for performance
