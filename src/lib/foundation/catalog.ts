...
export const INTEGRATION_CATALOG: IntegrationCatalogEntry[] = [
  ...
  // field; mock-mode degraded data when the key is absent. Companies House
  // uses the ported LTM client at `src/lib/companies-house/client.ts`.
  {
    id: "stripe",
    label: "Stripe",
    group: "ops",
  ...
  },
  {
    ...
    purpose: "Read-only UK company registration, filings, officer data for Q3 auto-fill (uses ported LTM client).",
  },
  {
