...
| FIX-5 | **Law 5 CI guard** — source-scan guard asserting every agent's `dataSources` entry is non-empty (precursor to strict-typing) | ⏳ Next | `src/lib/evaluation/agent-data-sources-guard.test.ts` | — |
